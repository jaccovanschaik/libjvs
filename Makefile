...
commit:
	...
	@git status
	@echo -n 'Message: '
	@read msg && svn commit -m "$$msg" && svn update \
           && git commit -a -m "$$msg" && git push

# Dependencies - generated by deps on Fri 23 Oct 2020 01:59:12 PM CEST
...
timespec.o: timespec.c timespec.h utils.h 
tree.o: tree.c tree.h debug.h utils.h 
