...
test: libjvs.a
	for f in `grep -l '#ifdef TEST' *.c`; do \
          base=`basename $$f .c`; \
          echo "Testing $$f"; \
          $(CC) $(CFLAGS) -DTEST -DDEBUG -D_GNU_SOURCE -o test-$$base $$f libjvs.a -lm; \
          ./test-$$base; \
        done

# Dependencies - generated by deps on Tue Aug 13 15:38:31 CEST 2013
...
mx.o: mx.c buffer.h list.h tcp.h udp.h defs.h debug.h hash.h utils.h mx.h net.h udp.h 
