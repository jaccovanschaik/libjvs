...
LIBJVS = vector.o buffer.o hash.o list.o dp.o debug.o cx.o \
         utils.o tgen.o bitmask.o net.o tcp.o udp.o log.o
...
clean:
	rm -f *.o libjvs.a libjvs.so core vgcore.* libjvs.tgz test-* tgen.[ch]
...
# Dependencies - generated by deps on Mon Jul  8 16:21:03 CEST 2013

bitmask.o: bitmask.c buffer.h bitmask.h tgen.h defs.h 
buffer.o: buffer.c buffer.h utils.h defs.h 
...
sdp.o: sdp.c list.h utils.h buffer.h sdp.h 
sdr.o: sdr.c defs.h sdr.h 
tcp.o: tcp.c net.h tcp.h debug.h 
tgen.o: tgen.c buffer.h tgen.h 
udp.o: udp.c net.h tcp.h debug.h net.h 
